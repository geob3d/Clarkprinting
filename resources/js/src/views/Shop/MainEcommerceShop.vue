                            ...
                            <div slot-scope="{
                              ...
                              refine,
                                ...
                                <ul>
                                    ...
                                    <li v-for="item in products" :key="item.id" class="mb-2 flex items-center justify-between">
                                        <vs-checkbox v-model="item.isRefined" class="ml-0" @click="refine(item.id)">{{ item.prod_cat_fk }}</vs-checkbox>
