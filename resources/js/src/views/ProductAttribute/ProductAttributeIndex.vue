<template>
  ...
  <div id="data-list-list-view" class="data-list-container">
   ...
   <!--  <data-view-sidebar :isSidebarActive="addNewDataSidebar" @closeSidebar="toggleDataSidebar" :data="sidebarData" /> -->
    ...
    <vs-table multiple v-model="selected" @selected="handleSelected" :data="productsAttrs">
        ...
        <div class="flex flex-wrap-reverse items-center data-list-btn-container">
            ...
            <!-- ACTION - DROPDOWN -->
             <div class="centerx ">
                ...
                <vs-popup class="holamundo"  title="Add New product" :active.sync="popupActivo">
                    <product-attr />
                </vs-popup>
            </div>
            ...
            <div class="p-4 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                <span class="mr-2">{{ currentPage * itemsPerPage - (itemsPerPage - 1) }} - {{ productsAttrs.length - currentPage * itemsPerPage > 0 ? currentPage * itemsPerPage : productsAttrs.length }} of {{ queriedItems }}</span>
                <feather-icon icon="ChevronDownIcon" svgClasses="h-4 w-4" />
            </div>
        ...
        <template slot="thead">
            <vs-th>ID</vs-th>
            <vs-th sort-key="sku">Banner</vs-th>
            <vs-th sort-key="name">Department</vs-th>
        ...
        <template slot-scope="{data}">
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                ...
                <vs-td :data="data[indextr].Dept_ID_fk">
                    {{data[indextr].Dept_ID_fk}}
                </vs-td>

                <vs-td :data="data[indextr].Prod_ID_fk">
                    {{data[indextr].Prod_ID_fk}}
                </vs-td>
                ...
                <vs-td class="whitespace-no-wrap">
                  ...
                  <router-link :to="{name: 'EditProduct', params: { id: tr.id }}">
...
import ProductAttr from './ProductAttributeAddSideBar'
...
export default {
    ...
    created() {
       this.getProducts();
       let uri = `/api/product/attributes/${this.$route.params.id}`;
          axios
            .get(uri)
            .then((response) => {
            this.productsAttrs = response.data.data;
         });
    ...
    methods: {
       ...
       // toggleDataSidebar(val=false) {
        ...
        deleteProducts(id){
          if (confirm(`Are you sure you want to delete Products ${id}?`)){
