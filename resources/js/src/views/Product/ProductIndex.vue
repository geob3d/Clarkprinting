<template>
  ...
  <div id="data-list-list-view" class="data-list-container">
   ...
   <!--  <data-view-sidebar :isSidebarActive="addNewDataSidebar" @closeSidebar="toggleDataSidebar" :data="sidebarData" /> -->
    ...
    <vs-table multiple v-model="selected" @selected="handleSelected" :data="products">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <template slot="thead">
            ...
            <vs-th sort-key="name">Ordering Company</vs-th>
            <vs-th sort-key="name">Product Category</vs-th>
            <vs-th sort-key="name">Product Image</vs-th>
        ...
        <template slot-scope="{data}">
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                ...
                <vs-td :data="data[indextr].ordering_company_id_fk">
...
import ProductAdd from './ProductAddSideBar'
